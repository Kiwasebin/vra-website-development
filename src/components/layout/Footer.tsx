      ...
      <div className="container grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <div className="flex items-center mb-4">
            <span className="text-3xl font-bold vra-gradient-text">VRA</span>
          </div>
          <p className="text-gray-400 mb-6">
            Virtual Reality Academy — школа будущего с технологиями настоящего. 
            Обучаем созданию и применению AR/VR технологий.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li><Link to="/courses" className="text-gray-400 hover:text-white transition-colors">Курсы</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-2">
              <MapPin size={18} className="text-vra-pink" />
              <span className="text-gray-400">Москва, ул. Технологическая, 42</span>
            </li>
            <li className="flex items-center gap-2">
              <Phone size={18} className="text-vra-pink" />
              <a href="tel:+74951234567" className="text-gray-400 hover:text-white transition-colors">+7 (495) 123-45-67</a>
            </li>
            <li className="flex items-center gap-2">
              <Mail size={18} className="text-vra-pink" />
              <a href="mailto:info@vra.ru" className="text-gray-400 hover:text-white transition-colors">info@vra.ru</a>
            </li>
            <li className="flex items-center gap-2">
              <Headset size={18} className="text-vra-pink" />
      ...
      <div className="container mt-8 pt-8 border-t border-gray-800">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © 2023 Virtual Reality Academy. Все права защищены.
          </p>
