        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300">
              Мы всегда рады ответить на ваши вопросы и помочь выбрать 
            ...
            <div className="lg:col-span-1 space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Найдите удобный способ связаться с нами
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    <MapPin className="h-5 w-5 text-vra-pink mt-0.5" />
                    <div>
                      <h3 className="font-medium">Адрес</h3>
                      <p className="text-muted-foreground">Москва, ул. Технологическая, 42</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Phone className="h-5 w-5 text-vra-pink mt-0.5" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <Mail className="h-5 w-5 text-vra-pink mt-0.5" />
                    <div>
                      <h3 className="font-medium">Email</h3>
                      <p className="text-muted-foreground">info@vra.ru</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Clock className="h-5 w-5 text-vra-pink mt-0.5" />
                    <div>
              ...
              <Card>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <Button 
                      type="submit" 
                      className="w-full bg-gradient-to-r from-vra-pink to-vra-blue text-white hover:opacity-90"
                    >
                      Отправить сооб щение
